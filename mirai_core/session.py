...
class Session(Bot):
    ...
    def getRestraintMapping(self):
        from mirai_core.models.message import MessageChain
    ...
    def get_annotations_mapping(self):
        ...
        return {
            ...
            components.Source: lambda k: k.body.messageChain.get_source() \
                if k.name in MessageTypes else \
